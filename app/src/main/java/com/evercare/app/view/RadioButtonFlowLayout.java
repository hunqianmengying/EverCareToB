 ...
 * 邮箱：842202389@qq.com
 * 自动换行RadioButtonFlowLayout
 */
public class RadioButtonFlowLayout extends RadioGroup {
    /**
     * 存储行的集合，管理行
     */
    ...
    public RadioButtonFlowLayout(Context context) {
        this(context, null);
    }

    public RadioButtonFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 计算最大的宽度
        mMaxWidth = width - getPaddingLeft() - getPaddingRight() - 80;
    ...
    public class Line {
        ...
        public void layout(int t, int l) {
            ...
            for (View view : views) {
                ...
                // 重新测量
                view.measure(MeasureSpec.makeMeasureSpec(measuredWidth + 15, MeasureSpec.EXACTLY),
