 ...
 * 客户详情  订购项目
 */
public class Order_ProjectFragment extends BaseFragment {
    private RecyclerView mRecyclerView;
    private static final String KEY = "key";
    private static String ARGUMENT = "custom_id";
    private String title = "订购项目表";
    ...
    public static Order_ProjectFragment newInstance(String custom_id) {
        Bundle bundle = new Bundle();
        bundle.putString(ARGUMENT, custom_id);
        Order_ProjectFragment contentFragment = new Order_ProjectFragment();
    ...
    private void searchData() {
        ...
        try {
            ...
            //jsonObject.put("custom_id", "820221");
        ...
        HttpUtils.postWithJson(context, Constant.CUSTOM_PROJECT, jsonObject, new JsonHttpResponseHandler() {
                    @Override
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        ...
                        try {
                            if (!TextUtils.isEmpty(response.getString("data"))) {
                                Gson gson = new Gson();
                                Type type = new TypeToken<JsonListResult<OrderProjectInfo>>() {
                                }.getType();
                                JsonListResult<OrderProjectInfo> jsonResult = gson.fromJson(response.toString(), type);

                                String code = jsonResult.getCode();
                                List<OrderProjectInfo> data = jsonResult.getData();

                                if (TextUtils.equals(code, Result.SUCCESS) && data != null && data.size() > 0) {
                                    ...
                                    if (page > 1) {
                                        ...
                                        if (adapter != null) {
                                            ...
                                            adapter = new OrderProjectAdapter(context, data);
