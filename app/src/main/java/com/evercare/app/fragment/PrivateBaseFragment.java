...
import static com.evercare.app.R.id.refreshLayout;
import static com.evercare.app.R.id.rlv_news;
 ...
 * 私有库
 */
public class PrivateBaseFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_privatebase;
    }
    ...
    public void initData() {
        ...
        try {
            jsonObject.put("type", Constant.PRIVATE_SEA);
                ...
                try {
                    if (!TextUtils.isEmpty(response.getString("data"))) {
                        ...
                        if (TextUtils.equals(code, Result.SUCCESS) && personList != null && personList.size() > 0) {
                            ...
                            adapter = new AddressListAdapter(getContext(), "PrivateBaseFragment", personList, new CustomerItemClickListener() {
                                @Override
                                ...
                                public void onItemLongClick(View view, final int position) {
                                    OceanActionDialog dialog = new OceanActionDialog(getContext(), personList.get(position).getName(), "私有库", new OceanActionDialog.ClickListenerInterface() {
                                        @Override
    ...
    private void seleaseCustomer(PersonInfo item, final String type, final int position) {
        ...
        try {
            ...
            jsonObject.put("ocean", item.getOcean());//1临时 2私有 3公海,原来的
