...
public class ConsultationFragment extends Fragment implements CustomerItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = (View) inflater.inflate(R.layout.fragment_customer, container, false);
        initViews(view);
        initData();
        return view;
    }
    ...
    private void initData() {
        txt_center.setText("咨询");
        fragmentList = new ArrayList<>();
        fragmentList.add(new RongMessageFragment());
