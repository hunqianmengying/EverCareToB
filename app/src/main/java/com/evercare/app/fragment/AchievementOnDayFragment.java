 ...
 * 销售额业绩显示    日
 */
public class AchievementOnDayFragment extends Fragment {
                        ...
                        if (TextUtils.equals(code, Result.SUCCESS) && achievmentInfos != null) {
                            ...
                            if (achievmentInfos.getSale_list() != null && achievmentInfos.getSale_list().size() > 0) {
                                if (page > 1) {
                                    ...
                                    tradeItemAdapter = new TradeItemAdapter(getContext(), achievmentInfos.getSale_list(), achievmentInfos, "日");
