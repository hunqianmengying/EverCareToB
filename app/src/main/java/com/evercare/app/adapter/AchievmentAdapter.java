 ...
 * 通讯录Adapter
 */
public class AchievmentAdapter extends RecyclerView.Adapter<AchievmentAdapter.ViewHolder> {
    ...
    public AchievmentAdapter(Context context, String tag, List<PersonInfo> personInfoList, CustomerItemClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = inflater.inflate(R.layout.achievment_layout, parent, false);
