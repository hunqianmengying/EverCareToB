...
import com.evercare.app.util.LunarCalendarUtil;
...
/*public CalendarAdapter() {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (item.getCurrentFlag()) {
            txt_day_number.setTextColor(context.getResources().getColor(R.color.header_bg));
            txt_day_number.setBackgroundResource(R.drawable.txt_circle_bg);
        }
        Log.w("是否可点点击", "" + item.getClickble());
        ...
        if (isShowAllDate) {
            ...
            if (item.getBackground() == 0) {
                ...
                txt_day_number.setTag(R.color.gray_b6);
            } else {
                txt_day_number.setTextColor(ContextCompat.getColor(context, R.color.header_text));
                txt_day_number.setTag(R.color.header_text);
            }
