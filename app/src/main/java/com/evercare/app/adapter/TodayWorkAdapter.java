 ...
 * 生日客户Adapter
 */
public class TodayWorkAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TodayWorkAdapter(Context context, TodayWorkInfo todayWorkInfo, CustomerItemClickListener clickListener) {
