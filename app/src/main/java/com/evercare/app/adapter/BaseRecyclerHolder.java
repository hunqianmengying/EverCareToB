...
/**
 * 作者：LXQ on 2016-11-28 2016-11-28
 * 邮箱：842202389@qq.com
 * RecycleView    Holder基类
 */
public class BaseRecyclerHolder extends RecyclerView.ViewHolder {
    ...
    public BaseRecyclerHolder setAdapter(int viewId, BaseRecyclerAdapter adapter) {
        RecyclerView rlv = getView(viewId);
        rlv.setAdapter(adapter);
        return this;
    }

    public BaseRecyclerHolder setLayoutManager(int viewId, RecyclerView.LayoutManager layoutManager) {
        RecyclerView rlv = getView(viewId);
    ...
    public BaseRecyclerHolder setBackgroundDrawable(int viewId, Drawable color) {
        View view = getView(viewId);
    ...
    public BaseRecyclerHolder setInVisible(int viewId, boolean visible) {
        View view = getView(viewId);
