...
public class CLog {
	...
	public static void i(String title, String message, boolean written2Disk) {
		Log.i(title, message);
		if(written2Disk){
	...
	public static void t(String title, Exception message, boolean written2Disk) {
	...
	public static void w(String title, String message, boolean written2Disk) {
		Log.w(title, message);
		if(written2Disk){
			writeLog(title, message);
		}
	...
	public static void v(String title, String message, boolean written2Disk) {
		Log.v(title, message);
		if(written2Disk){
			writeLog(title, message);
		}
	...
	public static void e(String title, String message, boolean written2Disk) {
		Log.e(title, message);
		if(written2Disk){
			writeLog(title, message);
		}
